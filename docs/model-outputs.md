...
生成されたモデルについて、Your Singer プロジェクトは権利を主張せず、**生成したユーザーのもの**とします。Your Singer 本体の Apache License 2.0 は生成モデルへ自動適用されません。

ただし、入力データや第三者のベースモデル / pretrained model 等に別の条件がある場合は、その条件が適用されることがあります。
